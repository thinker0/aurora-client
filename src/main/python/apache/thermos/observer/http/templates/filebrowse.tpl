...
<body>
  <div class="filename"> <strong> filename </strong> ${filename} <strong> dl </strong> ${download_link()} <button class="theme-toggle" id="theme-btn" onclick="toggleTheme()">Dark</button></div>
