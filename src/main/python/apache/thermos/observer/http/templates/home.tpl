...
<style>
  ...
  [data-theme="dark"] .zebra-striped tbody tr:nth-child(odd) td { background-color: var(--aurora-surface-alt); }
  [data-theme="dark"] .table-hover > tbody > tr:hover > td,
  [data-theme="dark"] .table-hover > tbody > tr:hover > th { background-color: #2a3a50; }
